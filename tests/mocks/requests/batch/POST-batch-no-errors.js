...
<list of="obix:BatchOut" xmlns="http://obix.org/ns/schema/1.0" xsi:schemaLocation="http://obix.org/ns/schema/1.0 /obix/xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <bool val="false" href="https://localhost:443/obix/config/Test/BooleanWritable/out" is="/obix/def/baja:StatusBoolean" display="false {ok} @ def" displayName="Out" icon="/ord?module://icons/x16/statusBoolean.png" range="https://localhost:443/obix/config/Test/BooleanWritable/out/~bool">
 </bool>
    <real val="50.0" is="/obix/def/control:NumericWritable /obix/def/control:NumericPoint obix:Point" display="50.0 {ok} @ def" icon="/ord?module://icons/x16/control/numericPoint.png" unit="obix:units/null">
        ...
        <real name="out" val="50.0" href="out/" is="/obix/def/baja:StatusNumeric" display="50.0 {ok} @ def" displayName="Out" icon="/ord?module://icons/x16/statusNumeric.png" unit="obix:units/null">
  </real>
        ...
        <real name="fallback" val="50.0" href="fallback/" is="/obix/def/baja:StatusNumeric" display="50.0 {ok}" displayName="Fallback" icon="/ord?module://icons/x16/statusNumeric.png" unit="obix:units/null">
  </real>
